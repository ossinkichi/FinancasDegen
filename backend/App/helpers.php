...
function message(array $message, int $code = 200): void
{
...
function sanitizeArray(array $datas)
{
    return array_map('htmlspecialchars', $datas);
}

function getData(string $input)
{
    return get_object_vars(json_decode($input));
}

function arrayValidate(array|string $arrayForValidate, ?array $keys = [0]): void
{
...
function convertType(array $datas, array $types)
{
...
function arrayValueNotNull(array|string $dataForValidate): void
{
